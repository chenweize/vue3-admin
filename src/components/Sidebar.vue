<template>
	<div class="sidebar">
		<el-menu
			...
			router
		>
			<template v-for="item in menuItems.filter(e => !e.hidden)">
				<template v-if="item.children">
					...
					>
						...
						<template v-for="subItem in item.children.filter(e => !e.hidden)">
							<!-- 二级菜单，含子菜单 -->
							<el-submenu
							...
							>
								...
								<!-- 三级菜单 -->
								<el-menu-item
									v-for="(threeItem, i) in subItem.children.filter(e => !e.hidden)"
									:key="i"
